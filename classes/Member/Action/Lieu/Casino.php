<?php
/** Gestion de l'interface d'un casino
*
* @package Member_Action
*/
class Member_Action_Lieu_Casino
{
	public static function generatePage(&$tpl, &$session, &$account, &$perso)
	{
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . 'html/Member/Action/Lieu/Casino.htm',__FILE__,__LINE__);
