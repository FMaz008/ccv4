...
class Mj_Item_SacMod
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Sac_Addmod.htm');
	}
	...
	private static function save()
	{
		...
		if (empty($_POST['db_valeur']) || !is_numeric($_POST['db_valeur'])){ $_POST['db_valeur'] = 0; }
		if (empty($_POST['db_pr']) || !is_numeric($_POST['db_pr'])){ $_POST['db_pr'] = 0; }
		if (empty($_POST['db_resistance'])){ $_POST['db_resistance'] = 0; }
		
		if (empty($_POST['db_capacite']) || !is_numeric($_POST['db_capacite'])){ $_POST['db_capacite'] = 0;}
