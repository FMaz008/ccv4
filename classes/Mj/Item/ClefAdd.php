<?php
/** Gestion de l'interface pour l'ajout d'items de type clef
*
* @package Mj
*/
class Mj_Item_ClefAdd
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		{
			self::save();
			die('<script>location.href="?mj=Item_Clef";</script>');
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Clef_Addmod.htm');
	}
	...
	private static function save()
	{
		...
		//Insertion de nouvelles actions associer a l'item
