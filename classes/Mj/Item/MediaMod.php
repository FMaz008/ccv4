...
class Mj_Item_MediaMod
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		{
			self::save();
			die("<script>location.href='?mj=Item_Media';</script>");
		}
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Media_Addmod.htm');
	}
	...
	private static function save()
	{
		...
		if (empty($_POST['db_pass'])){ $_POST['db_pass'] = "tous"; }
		...
		$prep->bindValue(':db_internet', $_POST['db_internet'], PDO::PARAM_INT);
