...
class Mj_Item_Inv_Cartebanque
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		$prep->bindValue(':inv_nobanque', $_POST['inv_nobanque'], PDO::PARAM_STR);
		$prep->bindValue(':inv_nocompte', $_POST['inv_nocompte'], PDO::PARAM_STR);
		$prep->bindValue(':inv_nocarte', $_POST['inv_nocarte'], PDO::PARAM_INT);
