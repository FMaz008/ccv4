...
class Mj_Item_TalkiewalkieAdd
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		{
			self::save();
			die("<script>location.href='?mj=Item_Talkiewalkie';</script>");
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Talkiewalkie_Addmod.htm');
	}
