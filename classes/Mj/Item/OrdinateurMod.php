...
class Mj_Item_OrdinateurMod
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Ordinateur_Addmod.htm');
	}
	...
	private static function save()
	{
		...
		if (empty($_POST['db_internet'])){ $_POST['db_internet'] = 0; }
		if (empty($_POST['db_mcread'])){ $_POST['db_mcread'] = 0; }
		...
		$prep->bindValue(':db_capacite', $_POST['db_capacite'], PDO::PARAM_STR);
		$prep->bindValue(':db_internet', $_POST['db_internet'], PDO::PARAM_STR);
		$prep->bindValue(':db_mcread', $_POST['db_mcread'], PDO::PARAM_STR);
