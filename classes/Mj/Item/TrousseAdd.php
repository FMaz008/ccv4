...
class Mj_Item_TrousseAdd
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		{
			self::save();
			die("<script>location.href='?mj=Item_Trousse';</script>");
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Trousse_Addmod.htm');
	}
