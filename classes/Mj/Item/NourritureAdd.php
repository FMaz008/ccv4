...
class Mj_Item_NourritureAdd
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		{
			self::save();
			die("<script>location.href='?mj=Item_Nourriture';</script>");
	...
	return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Nourriture_Addmod.htm');
	}
	...
	private static function save()
	{
		...
		$prep->bindValue(':db_pn', $_POST['db_pn'], PDO::PARAM_INT);
